...
Public Class ProblemDataExport
    ...
    Private Sub ProblemDataExport_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        GenerateCurrentDirectory()
        Dim CurrentPath As String = GetCurrentDirectory()
        txtExportPath.Text = CurrentPath
        lstDataToExport.ItemsSource = ProblemList
    ...
    Private Sub btnOK_Click(sender As Object, e As RoutedEventArgs) Handles btnOK.Click
        With ProblemDataOutputParameters
